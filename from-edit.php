    ...
    <form action="proses-edit.php" method="POST">
        <fieldset>
            ...
            <p>
                ...
                <input type="text" class="form-control" name="nama" placeholder="nama lengkap" required minlength="3" value="<?php echo $siswa['nama'] ?>" />
            </p>
            <p>
            ...
            <p>
                <label for="Asal_sekolah" class="form-label">Pangkalan: </label>
                <input type="text" class="form-control" name="pangkalan_asal" placeholder="nama sekolah" required value="<?php echo $siswa ['asal_sekolah'] ?>" />
            </p>
        </fieldset>
        <p>
